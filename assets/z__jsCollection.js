...
$(document).on('click','.arjunQuickAdd',function(e){  
  e.preventDefault();
...
$(document).on('click','.singleVariant',function(e){  
  e.preventDefault();
  ...
  setTimeout(function () {
     $.ajax({
        ...
        success: function(response) {
          $('.quickVariants-'+productId).toggle();
        },
...
$(document).on('click','.choose-quick-to-cart',function(e){  
  e.preventDefault();
